function [ int,lines ] = find_edge_lines6t( bord,pos,rotim,~ )
...
%About: 
% THIS TIME FOR TRUNCATED TRIANGLES/IRREGULAR HEXAGONS
%- create lines 120 deg apart for moving and adjusting 
