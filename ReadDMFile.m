...
% C. Yang, February 2019 
% Trying to figure out...how to format the file name? 
% make sure to do the thing with the .dm4 at the end...that was the only
% thing lol
...
%switched to big-endian for unknown reasons but I needed to do it
fb=fopen(filename,'r','n');
tic;
